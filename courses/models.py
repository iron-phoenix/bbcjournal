...
class Lesson(models.Model):
    ...
    date = models.DateField(blank = False, null = False, verbose_name = 'Дата урока', default = datetime.date.today)
...
class StudentLesson(models.Model):
    ...
    reason_for_abcense = models.CharField(max_length = 255, blank = True, default = '')
